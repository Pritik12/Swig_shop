...
class chini extends StatefulWidget {
  const chini({super.key});

  @override
  State<chini> createState() => chiniState();
}

class chiniState extends State<chini> {
  bool a = true;
  bool b = true;
  bool a1 = true;
  bool a3 = true;
          ...
          child: Column(
            children: [
              ...
              Padding(
                ...
                child: Text(
                  "Transport your taste buds to the heart of Chinese cuisine with these scrumptious dishes.",
