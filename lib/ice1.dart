...
class ice1 extends StatefulWidget {
  const ice1({super.key});

  @override
  State<ice1> createState() => ice1State();
}

class ice1State extends State<ice1> {
  bool a = true;
  bool b = true;
  bool a1 = true;
  bool a3 = true;
                          ...
                          children: [
                            ...
                            Padding(
                              ...
                              child: Container(
                                height: 30,
                                width: 370,
                                child: Text("4.2(200+rating)!. Rs.150 for two"),
                              ),
                            ),
                            Padding(
                              padding: const EdgeInsets.only(left: 10),
