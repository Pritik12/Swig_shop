...
class idli extends StatefulWidget {
  const idli({super.key});

  @override
  State<idli> createState() => idState();
}

class idState extends State<idli> {
  bool a = true;
  bool b = true;
  bool a1 = true;
  bool a3 = true;
        ...
        child: SingleChildScrollView(
          ...
          child: Column(
            children: [
              ...
              Padding(
                padding: const EdgeInsets.only(right: 335, top: 40),
                child: Text(
                  "Idli",
              ...
              Padding(
                padding: const EdgeInsets.only(right: 57, top: 10, bottom: 20),
                child: Text(
                  "Deliciously soft and healthy Idlis for an ideal breakfast.",
