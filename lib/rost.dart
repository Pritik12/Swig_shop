...
class rost extends StatefulWidget {
  const rost({super.key});

  @override
  State<rost> createState() => rostState();
}

class rostState extends State<rost> {
  bool a = true;
  bool b = true;
  bool a1 = true;
  bool a3 = true;
                          ...
                          children: [
                            ...
                            Padding(
                              ...
                              child: Container(
                                height: 30,
                                width: 370,
                                child: Text("4.1(2k+rating)!. Rs.399 for two"),
                              ),
                            ),
                            Padding(
                              padding: const EdgeInsets.only(left: 10),
