...
class pizz1 extends StatefulWidget {
  const pizz1({super.key});

  @override
  State<pizz1> createState() => pizz1State();
}

class pizz1State extends State<pizz1> {
  bool a = true;
  bool b = true;
  bool a1 = true;
  bool a3 = true;
        ...
        child: SingleChildScrollView(
          ...
          child: Column(
            children: [
                          ...
                          children: [
                            ...
                            Padding(
                              ...
                              child: Container(
                                height: 30,
                                width: 370,
                                child: Text("3.9(20+rating)!. Rs.450 for two"),
                              ),
                            ),
                            Padding(
                              padding: const EdgeInsets.only(left: 10),
              ...
              //   decoration: BoxDecoration(border: Border.all(color: Color.fromARGB(181, 194, 227, 236)),color: Color.fromARGB(58, 94, 94, 94),borderRadius: BorderRadius.circular(20)),
              //   child: Row(
              //     children: [
              //       Container(
              //         height: 40,
              //         width: 280,
              //         child: Center(child: Text("Search for dishes",style: TextStyle(fontSize: 20),)),
              //       ),
              //       Container(
              //         height: 40,
              //         width: 40,
