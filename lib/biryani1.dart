...
class birya1 extends StatefulWidget {
  const birya1({super.key});

  @override
  State<birya1> createState() => birya1State();
}

class birya1State extends State<birya1> {
  bool a = true;
  bool b = true;
  bool a1 = true;
  bool a3 = true;
                          ...
                          children: [
                            ...
                            Padding(
                              ...
                              child: Container(
                                height: 30,
                                width: 370,
                                child: Text("4.4(50k+rating)!. Rs.500 for two"),
                              ),
                            ),
                            Padding(
                              padding: const EdgeInsets.only(left: 10),
